...
export class AnalyticsService {
  ...
  getOrganizerDashboard(role: UserRole, userId: string): any {
    ...
    if (!organizer) return { success: false, message: 'Organizer profile not found' };
  ...
  getStaffDashboard(role: UserRole, userId: string): any {
    ...
    if (!staffUser) return { success: false, message: 'Staff profile not found' };
  ...
  getAttendeeDashboard(role: UserRole, userId: string): any {
    ...
    if (!attendeeUser) return { success: false, message: 'Attendee profile not found' };
